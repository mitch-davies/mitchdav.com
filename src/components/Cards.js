...
function Cards() {
  ...
  <div className="project-card-container">
        <div className="project-card" data-aos="fade-up">
            <img src="/images/prodigy.png" alt="project display" className="project-image" loading="lazy"/>
        ...
        <div className="project-card" data-aos="fade-up">
            <img src="/images/crossfire.png" alt="project display" className="project-image" loading="lazy"/>
            <div className="project-info">
        ...
        <div className="project-card" data-aos="fade-up">
            <img src="/images/offerzen.png" alt="project display" className="project-image" loading="lazy"/>
            <div className="project-info">
